      ...
      <div className="diagnosticGrid">
        <section className="panel" aria-label="Diagnosis summary">
          ...
          <div className="summaryGrid">
            <Metric label="successes" tone="pass" value={report.summary.successes} />
            <Metric label="failures" tone="fail" value={report.summary.failures} />
            <Metric label="blocked" tone="warn" value={report.summary.blocked} />
