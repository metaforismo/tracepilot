...
export default async function HomePage() {
  ...
  return (
    <StudioShell icon={<Gauge size={18} />} subtitle="Computer-use reliability">
      ...
      <section className="overviewGrid" aria-label="TracePilot overview">
        ...
        <div className="evidenceBoard" aria-label="Evidence summary">
          <Metric className="evidenceMetricTile" label="Provider runs" value={`${providerSummary.executedRuns}/${providerSummary.plannedRuns}`} />
          <Metric className="evidenceMetricTile" label="Paid calls" value={providerSummary.paidCalls} />
          <Metric className="evidenceMetricTile" label="Success rate" value={formatPercent(providerSummary.successRate)} />
          <Metric className="evidenceMetricTile" label="Unsafe blocks" value={providerSummary.unsafeBlocks} />
          <Metric className="evidenceMetricTile" label="Total cost" value={formatUsdCompact(providerSummary.totalCostUsd)} />
          <Metric className="evidenceMetricTile" label="Generated" value={shortDate(generatedAt)} />
        </div>
